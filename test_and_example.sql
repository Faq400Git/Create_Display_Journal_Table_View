...
call FAQ400.CREATE_DISPLAY_JOURNAL_TABLE_VIEW('FAQ400JOU', 'MYSAMPLETABLE', 'FAQ400JOU', 'QSQJRN', 'FAQ400JOU', 'V_MYSAMPLETABLE_AUDIT', 'Y', GV_VARCHAR);

-- We can view the SQL Statement for the view
select GV_VARCHAR FROM SYSIBM.SYSDUMMY1;
